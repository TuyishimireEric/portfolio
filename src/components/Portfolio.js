            ...
            <div className='project-container'>
                <div className='project'>
                    ...
                    <div className='project-desc'>
                        ...
                        <div className='description'>
                            <p>The project is based on an app to book an appointment to try a Car. 
                                User see all cars in database and is able to book and try one. 
                                User can add and delete a car if user role is admin</p>
                ...
                <div className='project'>
                    ...
                    <div className='project-desc'>
                        ...
                        <h3>CHOGM-2022</h3>
                        <div className='description'>
                            <p>This is a Capstone CHOGM meeting website the 20th june 2022 - 25th june 2022, 
                                ...
                                to inform and give informations about the meeting.</p>
                ...
                <div className='project'>
                    ...
                    <div className='project-desc'>
                        ...
                        <h3>Movie Series</h3>
                        <div className='description'>
                            <p>This is JavaScript Module capstone project, and this project is about building a web application
                                 based on an external API. we have selected an API that provides data and another wich adds the
                                  comments and likes about movie series and then built the webapp around it.</p>
                ...
                <div className='project'>
                    ...
                    <div className='project-desc'>
                        ...
                        <h3>Leader Board</h3>
                        <div className='description'>
                            <p>This is a JavaScript project for the Leaderboard list app, 
                                using webpack and ES6 features, notably modules.</p>
                ...
                <div className='project'>
                    ...
                    <div className='project-desc'>
                        ...
                        <div className='description'>
                            <p>This project is based on an eCommerce website built with React and Redux.
                                 The user can check all the products in our and get more details on 
                                selected product. The user can also search for a product in our store.</p>
